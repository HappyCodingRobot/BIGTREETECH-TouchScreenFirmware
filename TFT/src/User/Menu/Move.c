...
void menuMove(void)
{
  ...
  while(infoMenu.menu[infoMenu.cur] == menuMove)
  {
    ...
    switch(key_num)
    {
        ...
        case KEY_ICON_1: storeMoveCmd(X_AXIS, -1); break;  // X move decrease if no invert
        ...
        case KEY_ICON_4: storeMoveCmd(Y_AXIS, 1); break; // Y move increase if no invert
        case KEY_ICON_5: storeMoveCmd(X_AXIS, 1); break; // X move increase if no invert
        case KEY_ICON_6: storeMoveCmd(Y_AXIS, -1); break;  // Y move decrease if no invert
